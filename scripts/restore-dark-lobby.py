...
if current.get('release_revision') in ('results-capture-20260921','accounts-20260922','social-login-reset-20260922','web-google-login-20260922','web-account-layout-20260922','web-linked-ranking-20260922','web-result-share-20260922'):
    ...
    if current.get('release_revision') in ('accounts-20260922','social-login-reset-20260922','web-google-login-20260922','web-account-layout-20260922','web-linked-ranking-20260922','web-result-share-20260922'):
        assert current['account_ui'] and current['email_auth_ready'] is False
        assert 'delete-account.html' in current['build_files_sha256']
    if current.get('release_revision') in ('web-google-login-20260922','web-account-layout-20260922','web-linked-ranking-20260922','web-result-share-20260922'):
