...
def verify(base, out):
    ...
    report = {'base_url':base, 'game_version':'1.5.3', 'network':'Isolated API fixtures; no production writes', 'tests':[]}
    with sync_playwright() as p:
        ...
        for width, height in [(360,640),(390,844),(412,915)]:
            for discovered in (False, True):
                ...
                page.goto(base+'?recipe-tiers=1.5.3', wait_until='domcontentloaded')
